...
u1 = User.create(:email => 'bob@bob.com', :password => 'bob', :password_confirmation => 'bob')
u2 = User.create(:email => 'joe@joe.com', :password => 'joe', :password_confirmation => 'joe')
u3 = User.create(:email => 'sue@sue.com', :password => 'sue', :password_confirmation => 'sue')
