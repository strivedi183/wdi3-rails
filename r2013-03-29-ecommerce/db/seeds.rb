...
User.create(email: 'trivedi.sandip+1@gmail.com', password: 'a', password_confirmation: 'a', balance: 1_000)
User.create(email: 'trivedi.sandip+2@gmail.com', password: 'a', password_confirmation: 'a', balance: 5_000)
User.create(email: 'trivedi.sandip+3@gmail.com', password: 'a', password_confirmation: 'a', balance: 9_000)
admin = User.create(email: 'trivedi.sandip@gmail.com', password: 'a', password_confirmation: 'a')
admin.is_admin = true
admin.save
