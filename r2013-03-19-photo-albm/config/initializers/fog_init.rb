...
CarrierWave.configure {|config| config.fog_directory = 'albm-st-test'} if Rails.env.test?
CarrierWave.configure {|config| config.fog_directory = 'albm-st-regular'} if Rails.env.production?